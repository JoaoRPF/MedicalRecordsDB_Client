...
public class MedRecDBClient {
	...
	public static String[] getCredentials() throws UsernameDoesntExistException, InvalidPasswordException {
	...
	public static void main(String arg[]) throws Exception {
		...
		Registry registry = LocateRegistry.getRegistry("193.136.167.82", 9999, new SslRMIClientSocketFactory());
